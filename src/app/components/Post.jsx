...
function Post({ post }) {
    ...
    // Calculate the number of likes based on the post's original likes and local liked state
    const likesCount = useMemo(() => {
        // If the post is locally liked, add 1 to the original count.
        // Otherwise, the count is the original count.
        // This is a much safer way to manage the count without a separate state.
    ...
    const toggleLike = useCallback(() => {
        ...
        // Simply toggle the 'liked' state. The likesCount will be recalculated.
        setLiked(prev => !prev);
    }, [isLoggedIn, dispatch]);
